...
if (!isset($_SESSION['operator_id'])) {
    ...
    $AR_Operator_Name = mysqli_real_escape_string($conn, $_SESSION["Operator_Name"]);



    $Admin_Report_Insert = "INSERT INTO `admin_report`(`cus_bill_id`, `a_r_date`, `a_r_discount`, `a_r_total`, `a_r_final_total`,`op_id`,`op_uname`) VALUES ('$AR_cus_bill_id','$AR_date','$AR_discount','$AR_total','$AR_final_total','{$_SESSION['operator_id']}','$AR_Operator_Name')";
    ...
    if ($Admin_Report_ADD_Process) {
        ...
        $_SESSION["AR_cus_bill_id"] = $AR_cus_bill_id;
    } else {
