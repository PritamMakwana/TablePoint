...
?>
    ...
    <body>
        ...
        <div class="col-md-2">
            <a class="btn btn-warning text-white mb-2 ms-5 mt-2" href="category.php">back</a>
        </div>

        <p class="d-flex justify-content-center text-warning fs-2 m-2"><?php echo $_GET['cate_name']; ?></p>
