        ...
        if (mysqli_num_rows($resultu) > 0) {
            while ($row = mysqli_fetch_assoc($resultu)) { ?>
                ...
                <div class="create-account-form" id="create-account-form">
                    <h2 class="heading create-heading"> Profile Edit </h2>
                    <form class="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <button id="btn_create_account_click" type="submit" name="Update_Account" class="btn btn-outline-light btnSubmit btnCreate">Update Account</button>
                    </form>
